...
tModuleProperties gModuleProperties[] = {
    ...
    {"Unknown",      0,  0, 0, NULL             },
    {"OscB",         5,  0, 0, NULL             },
    {"OscShpB",      4, 10, 1, render_OscShpB   },
    {"OscC",         3,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"Reverb",       3,  0, 0, NULL             },
    {"OscString",    3,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"Sw8-1",        4,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"ValSw1-2",     2,  0, 0, NULL             },
    {"X-Fade",       2,  0, 0, NULL             },
    {"Mix4-1B",      2,  0, 0, NULL             },
    {"EnvADSR",      4,  8, 5, render_EnvAdsr   },
    {"Mux1-8",       2,  0, 0, NULL             },
    {"PartQuant",    2,  0, 0, NULL             },
    {"ModADSR",      5,  0, 0, NULL             },
    {"LfoC",         2,  0, 0, NULL             },
    {"LfoShpA",      5,  0, 0, NULL             },
    {"LfoA",         3,  0, 0, NULL             },
    {"OscMaster",    3,  0, 0, NULL             },
    {"Saturate",     2,  0, 0, NULL             },
    {"MetNoise",     2,  0, 0, NULL             },
    {"Device",       3,  0, 0, NULL             },
    {"Noise",        2,  0, 0, NULL             },
    ...
    {"EnvAHD",       4,  0, 0, NULL             },
    {"Pan",          2,  0, 0, NULL             },
    {"MixStereo",    5,  0, 0, NULL             },
    {"FltMulti",     4,  7, 6, render_FltMulti  },
    {"ConstSwT",     2,  0, 0, NULL             },
    {"FltNord",      5,  0, 0, NULL             },
    {"EnvMulti",     6,  0, 0, NULL             },
    {"SandH",        2,  0, 0, NULL             },
    {"FltStatic",    3,  0, 0, NULL             },
    {"EnvD",         2,  0, 0, NULL             },
    {"Resonator",    5,  0, 0, NULL             },
    {"Automate",     2,  0, 0, NULL             },
    {"DrumSynth",    8,  0, 0, NULL             },
    {"CompLev",      2,  0, 0, NULL             },
    {"Mux8-1X",      3,  0, 0, NULL             },
    {"Clip",         2,  0, 0, NULL             },
    {"Overdrive",    2,  0, 0, NULL             },
    {"Scratch",      3,  0, 0, NULL             },
    {"Gate",         2,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"Mix2-1B",      2,  0, 0, NULL             },
    ...
    {"ClkDiv",       2,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"EnvFollow",    2,  0, 0, NULL             },
    {"NoteScaler",   2,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"WaveWrap",     2,  0, 0, NULL             },
    {"NoteQuant",    2,  0, 0, NULL             },
    {"SwOnOffT",     2,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"Sw1-8",        4,  0, 0, NULL             },
    {"Sw4-1",        3,  0, 0, NULL             },
    ...
    {"Sw1-2",        2,  0, 0, NULL             },
    {"FlipFlop",     2,  0, 0, NULL             },
    {"FltClassic",   4,  6, 4, render_FltClassic},
    {"Unknown",      0,  0, 0, NULL             },
    {"StChorus",     3,  3, 3, render_StChorus  },
    {"Unknown",      0,  0, 0, NULL             },
    {"OscD",         2,  0, 0, NULL             },
    {"OscA",         3,  0, 0, NULL             },
    {"FreqShift",    3,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"Sw2-1",        2,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"FltPhase",     5,  0, 0, NULL             },
    ...
    {"Fade1-2",      2,  0, 0, NULL             },
    {"Fade2-1",      2,  0, 0, NULL             },
    {"LevScaler",    3,  0, 0, NULL             },
    {"Mix8-1A",      2,  0, 0, NULL             },
    {"LevMod",       3,  0, 0, NULL             },
    {"Digitizer",    3,  0, 0, NULL             },
    {"EnvADDSR",     5,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"SeqNote",      9,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"Mix4-1C",      4, 10, 5, render_Mix4to1c  },
    {"Mux8-1",       2,  0, 0, NULL             },
    {"WahWah",       2,  0, 0, NULL             },
    {"Name",         1,  0, 0, NULL             },
    {"Fx-In",        2,  0, 0, NULL             },
    ...
    {"NoteRcv",      2,  0, 0, NULL             },
    {"NoteZone",     3,  0, 0, NULL             },
    {"Compress",     5,  7, 2, render_Compress  },
    {"Unknown",      0,  0, 0, NULL             },
    {"KeyQuant",     2,  0, 0, NULL             },
    {"Unknown",      0,  0, 0, NULL             },
    {"SeqCtr",       8,  0, 0, NULL             },
    ...
    {"2-In",         2,  0, 0, NULL             },
    {"4-In",         2,  0, 0, NULL             },
    {"DlySingleA",   2,  0, 0, NULL             },
    {"DlySingleB",   2,  0, 0, NULL             },
    {"DelayDual",    3,  0, 0, NULL             },
    {"DelayQuad",    5,  0, 0, NULL             },
    {"DelayA",       3,  0, 0, NULL             },
    {"DelayB",       4,  0, 0, NULL             },
    {"DlyClock",     2,  0, 0, NULL             },
    {"DlyShiftReg",  2,  0, 0, NULL             },
    {"Operator",    12,  0, 0, NULL             },
    {"DlyEight",     3,  0, 0, NULL             },
    {"DlyStereo",    5,  0, 0, NULL             },
    {"OscPM",        3,  0, 0, NULL             },
    {"Mix1-1A",      2,  0, 0, NULL             },
    {"Mix1-1S",      2,  0, 0, NULL             },
    {"Sw1-2M",       2,  0, 0, NULL             },
