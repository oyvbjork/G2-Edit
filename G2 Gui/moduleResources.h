...
const tParamLocation paramLocationList[] = {
    {moduleTypeOscShpB,    paramType1CommonDial,            paramType2Dial,   32, 60, NULL,      128, 64, NULL           },
    ...
    {moduleTypeOscShpB,    paramType1CommonDial,            paramType2Dial,   62, 60, NULL,      128,  0, NULL           },
    ...
    {moduleTypeMix4to1C,   paramType1CommonDial,            paramType2Dial,   15, 60, NULL,      128,  0, NULL           },
    {moduleTypeMix4to1C,   paramType1CommonDial,            paramType2Dial,   30, 60, NULL,      128,  0, NULL           },
    {moduleTypeMix4to1C,   paramType1CommonDial,            paramType2Dial,   45, 60, NULL,      128,  0, NULL           },
    {moduleTypeMix4to1C,   paramType1CommonDial,            paramType2Dial,   60, 60, NULL,      128,  0, NULL           },
    {moduleTypeMix4to1C,   paramType1Enable,                paramType2Toggle, 20, 40, NULL,        2,  0, NULL           },
    {moduleTypeMix4to1C,   paramType1Enable,                paramType2Toggle, 35, 40, NULL,        2,  0, NULL           },
    {moduleTypeMix4to1C,   paramType1Enable,                paramType2Toggle, 50, 40, NULL,        2,  0, NULL           },
    {moduleTypeMix4to1C,   paramType1Enable,                paramType2Toggle, 65, 40, NULL,        2,  0, NULL           },
    {moduleTypeMix4to1C,   paramType1Exp,                   paramType2Toggle,  0, 25, NULL,        2,  0, NULL           },
    {moduleTypeMix4to1C,   paramType1Pad,                   paramType2Toggle,  0, 45, NULL,        2,  0, NULL           },
